...
class SignInPageDriver extends StatefulWidget {
  const SignInPageDriver({super.key});

  @override
  State<SignInPageDriver> createState() => _SignInPageDriverState();
}
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                CommonTextLabel(
                  text:
                      'Welcome, Driver! Sign in to Jodally to manage your rides and earn with ease. Let’s drive!',
                  fontFamily: 'Nunito',
